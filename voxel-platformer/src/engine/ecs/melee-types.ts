...
export const MELEE_ATTACK_DEFS = {
    ...
    'player-spear-thrust': {
        id: 'player-spear-thrust',
        startupSeconds: HUMANOID_ANIM_TIMINGS.spearImpact,
        activeSeconds: 0.07,
        recoverySeconds: Math.max(0, HUMANOID_ANIM_TIMINGS.spearAttack - HUMANOID_ANIM_TIMINGS.spearImpact - 0.07),
        shape: {
            kind: 'wedge',
            range: 3.1,
            arcRadians: Math.acos(0.88) * 2,
            minY: -PLAYER_MELEE_REACH_BELOW,
            maxY: PLAYER_MELEE_REACH_ABOVE,
        },
        targetMode: 'nearest',
