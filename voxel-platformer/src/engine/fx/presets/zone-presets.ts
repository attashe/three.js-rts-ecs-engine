...
export const ZONE_PRESETS: Record<string, ZonePreset> = {
    ...
    blizzard: { id: 'blizzard', label: 'Blizzard',
        params: { type: 'snow', name: 'Blizzard', color: '#f8fcff', count: 3200, particleSize: 0.12, opacity: 0.88, speed: 4.1, turbulence: 3.1, windX: 4.2, windZ: -1.6, gravity: 0.18, lifetime: 6.2, streaks: false, streakLength: 0.2, lightEnabled: false, lightColor: '#e4f4ff', lightIntensity: 0.5, lightDistance: 20, lightning: false, size: { x: 28, y: 12, z: 28 } },
    },
