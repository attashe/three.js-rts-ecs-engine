    ...
    return [
        ...
        },
        {
            ...
            name: 'spearAttack', duration: HUMANOID_ANIM_TIMINGS.spearAttack, tracks: [
                ...
                eulerQuatTrack('Chest', [
                    { t: 0, e: [0.02, -0.06, 0] },
                    { t: 0.12, e: [-0.2, -0.3, -0.045] },
                    { t: 0.22, e: [-0.24, -0.32, -0.05] },
                    { t: HUMANOID_ANIM_TIMINGS.spearImpact, e: [0.42, 0.01, 0] },
                ...
                eulerQuatTrack('UpperArmR', [
                    ...
                    { t: 0.12, e: [0.85, 0.3, -0.3] },
                    { t: 0.22, e: [1.25, 0.32, -0.32] },
                    { t: HUMANOID_ANIM_TIMINGS.spearImpact, e: [-0.6, 0.02, -0.02] },
